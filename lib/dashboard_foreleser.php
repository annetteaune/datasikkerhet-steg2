...
if (!isset($_SESSION['foreleser_fname'])) {
    error_log("No foreleser_fname in session - redirecting to login");
...
<body>
    <header>
        <nav>
            ...
            <ul class="nav-links">
                <h2>Velkommen, <?php echo htmlspecialchars($_SESSION['foreleser_fname'] . '
                     ' . $_SESSION['foreleser_lname']); ?>!</h2>
        ...
        <section class="intro">
            <div class="container">
                <div class="header">
                    ...
                    <div class="user-info">
                        <span>Velkommen, <?php echo htmlspecialchars($_SESSION['foreleser_fname'] . ' 
                            ' . $_SESSION['foreleser_lname']); ?></span>
    ...
    <footer>
        <div class="container">
            <p>&copy; <?php echo date("Y"); ?> 
                HearMeOut - Et kommunikasjonsverktøy for studenter og forelesere</p>
        </div>
    </footer>
